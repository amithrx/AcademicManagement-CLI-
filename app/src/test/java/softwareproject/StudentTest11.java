...
public class StudentTest11 {
    ...
    public void tearDown(){
        try {
            ...
            String query="DELETE FROM s_2023csb1070 WHERE course_code='hs301' AND instructor_id=amritesh@iitrpr.ac.in";
            statement.executeUpdate(query);
            query="DELETE FROM hs301_amritesh WHERE email_id='2023csb1070@iitrpr.ac.in'";
            statement.executeUpdate(query);
