...
public class InstructorTest6 {
    ...
    @Test
    void instructorCheckUpdateGrade1(){
        Instructor i=new Instructor("Balwinder Sodhi", "sodhi@iitrpr.ac.in", conn);
        assertTrue(i.checkUpdateGrade("cs305"));
    }
    @Test
    void instructorCheckUpdateGrade2(){
        Instructor i=new Instructor("Balwinder Sodhi", "sodhi@iitrpr.ac.in", conn);
        assertFalse(i.checkUpdateGrade("cs101"));
    }
    @AfterEach
